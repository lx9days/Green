...
export default class RenderHierarchyBackground{
    constructor(element) {
    ...
    _generateBackgroundPolygon(){
        const {x,y}=this.origionElement.getLocation();
        const elementPosition={
            x:x-this.style.width/2,
            y:y,
        }
        ...
        this.hasHideChildren=this.origionElement.hasHideChildren();
        if(this.hasHideChildren){
     ...
     */
    _generateStyle() {
        let styles= this.origionElement.getStyles();
